...
%
Para libros con textos modernos = \textbf{Autor, A. (Fecha). \emph{Título} (Ed./Tr.= Nombre, N. y Nombre, N.). (Vol. X, T. Y/Fasc. Y, Z\textsuperscript{ed.}). Editorial. <Enlace>. (= Sigla).}\par
Para libros con textos antiguos = \textbf{Editor, E. (Fecha). \emph{Título} (Au.= Nombre, N. \& Nombre, N.). (Vol. X, T. Y/Fasc. Y, Z\textsuperscript{ed.}). Editorial. <Enlace>. (= Sigla).}\par
